import group5 from '../../../../src/assets/grupo5.png'
    ...
    return (
        <div className='card' style={{width: width, height: height}}>
            <div className='card-header' style={{marginTop: margins?.marginTopHeader}}>
                {icon ? <img src={icon} alt="img" className='card-icon'/> : <img src={group5} alt="img" className='card-icon'/>}
                ...
                {dots ? <img src={group2} alt="img" className='card-dots'/> : null}
            </div>
